...
public class basketballRoster
{
  ...
  public basketballRoster() {
    ...
    basketballPlayerPic mitch = new basketballPlayerPic("img/mitch.jpeg","4", "Mitch McGary", "6-10", "Forward");
    ...
    basketballPlayerPic nik = new basketballPlayerPic("img/nik.jpeg","11", "Nik Stauskas", "6-6", "Guard");
    ...
    basketballPlayerPic blakeMc = new basketballPlayerPic("img/blakeMc.jpeg","22", "Blake McLimans", "6-10", "Forward");
